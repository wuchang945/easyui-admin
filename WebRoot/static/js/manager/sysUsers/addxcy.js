function chaUserName(){
	...
	if(enterpriseid.trim()==null||enterpriseid.trim()==""){
		...
		$('#manager_form').form('submit',{
					url : basePath+"/manager/SysUsersController/addxcy.do?buttonName="+buttonName+"&buttonCode="+buttonCode+"&action="+action+"&page="+page,onSubmit : function() {
					...
					success : function(result) {
						...
						if (mess.error == 'true') {
							...
							top.framework.closeAndReloadTab('巡查员操作', menuname,
									'xcygl');
						}
					}
				});
