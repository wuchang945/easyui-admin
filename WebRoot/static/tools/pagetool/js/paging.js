...
(function (root, factory) {
	...
	Paging.prototype = {
		...
		format: function () {
			var html = '<ul>'
		     html += '<li><span>记录总数：'+this.count+'</span></li>'
		...
		bindToolbar: function () {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><select class="ui-select-pagesize"></select><input type="text" class="ui-paging-count"/><a href="javascript:void(0)">跳转</a><span>第'+(this.count==0?'0/0':(this.current+'/'+this.pagecount))+'页</span></li>');
