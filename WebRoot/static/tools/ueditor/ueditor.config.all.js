...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,imageFieldName:"ueupload"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,imageManagerPath:PROURL + "/images/ue"                                    //图片修正地址，同imagePath
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'rowspacingtop', 'rowspacingbottom', 'lineheight','|','horizontal', 'date', 'time', 'spechars'
            ],
            ['customstyle', 'paragraph', 'fontfamily', 'fontsize', '|',
             ...
             ['insertimage', 'background','template','imagenone', 'imageleft', 'imageright', 'imagecenter','|',
